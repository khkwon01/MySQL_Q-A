...
- 제거된 사용자 권한
  ```
  Revoked Global Level Privileges (Doc ID 2707037.1)
  The following privileges are NOT granted to the default user created by MySQL Database Service.
